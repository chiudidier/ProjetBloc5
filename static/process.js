$(document).ready(function(){
    ...
    var state = $("#taquin").attr("etat-initial")
    ...
    function update(state, num){
        ...
        etat = state.replace(regex, function($1) { return $1 === num ? '0' : num });
        // Mise à jour de l'état du taquin dans la balise div
        $("#taquin").attr("etat",etat);
        // Récupération et mise à jour du compteur de coup
        compteur = parseInt($("#taquin").attr("compteur")) + 1;
        $("#taquin").attr("compteur",compteur.toString());
        return etat
    };
